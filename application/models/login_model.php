    ...
    public function changeAccountType()
    {
        if (isset($_POST["user_account_upgrade"]) AND !empty($_POST["user_account_upgrade"])) {
            ...
            if ($query->rowCount() == 1) {
                ...
                //Session::set('user_account_type', 1);//this line drops the user to 1 if he is e.g. 3
                Session::set('user_account_type', (Session::get('user_account_type')-1)); // this line set the actual type -1
